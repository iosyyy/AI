...
import {Button, Form, Input, message, Modal, Radio, Row, Space, Spin, Switch, Table,} from "antd";
                        ...
                        <Form.Item style={{margin: 0, padding: 0}} {...tailLayout}>
                            <a
                                onClick={() => {
                                    ...
                                    //   modal: true,
                                    // });
                                    FileSaver.saveAs(api.downloadIntroduction +`?params_name=${this.props.selectValue}` )
                                    // axios.post("http://localhost:8080/v1/client/download/conf_params", {params_name: this.props.selectValue})
                                    //     .then(data => /
                                    ...
                                    //                 });
                                    //                 FileSaver.saveAs(blob, this.props.selectValue + "说明文档.docx");
                                    //             })
                                    //             .catch((r) => {
                                    //                 console.log(r)
